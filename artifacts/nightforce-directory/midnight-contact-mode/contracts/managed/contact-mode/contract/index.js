...
export var ContactMode;
(function (ContactMode) {
  ContactMode[ContactMode['NO_CONTACT'] = 0] = 'NO_CONTACT';
  ContactMode[ContactMode['PRIVATE_CONTACT_AVAILABLE'] = 1] = 'PRIVATE_CONTACT_AVAILABLE';
  ContactMode[ContactMode['PUBLIC_CONTACT_ALLOWED'] = 2] = 'PUBLIC_CONTACT_ALLOWED';
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      setContactMode: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`setContactMode: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const nextMode_0 = args_1[1];
        ...
        const result_0 = this._setContactMode_0(context,
                                                partialProofData,
                                                nextMode_0);
    ...
    this.provableCircuits = { setContactMode: this.circuits.setContactMode };
  }
  initialState(...args_0) {
    if (args_0.length !== 2) {
    ...
    state_0.setOperation('setContactMode', new __compactRuntime.ContractOperation());
