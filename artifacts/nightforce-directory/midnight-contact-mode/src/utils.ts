...
export const CONTACT_MODE_PRIVATE_STATE_ID = "contactModeState";
...
export const ContactModeContract = await import(pathToFileURL(contractPath).href);
...
export async function createProviders(
  ...
  const privateStoragePasswordProvider = () =>
    "NightforceContactMode#2026!Only";

  return {
    privateStateProvider: (levelPrivateStateProvider as any)({
      privateStateStoreName: CONTACT_MODE_PRIVATE_STATE_ID,
      accountId,
